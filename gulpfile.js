...
gulp.task('compass', function() {
    return gulp.src('./app/assets/stylesheets/*.scss')
        ...
        .pipe(gulp.dest('./app/assets/stylesheets/ccss'))
        .pipe(refresh(lrserver));
});


// template change task
gulp.task('jade', function() {
    return gulp.src('./app/assets/views/templates/**/*.jade')
...
gulp.task('watch', function () {
    gulp.watch('./app/assets/views/templates/**/*.jade',['jade']);
